...
# 1. Load the datasets from the 'csv' folder
df_tesla = pd.read_csv('csv/TESLA Search Trend vs Price.csv')
df_btc_search = pd.read_csv('csv/Bitcoin Search Trend.csv')
df_btc_price = pd.read_csv('csv/Daily Bitcoin Price.csv')
df_unemployment = pd.read_csv('csv/UE Benefits Search vs UE Rate 2004-19.csv')
